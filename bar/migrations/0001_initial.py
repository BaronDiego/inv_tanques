# Generated by Django 3.2.6 on 2021-11-02 16:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terminal', models.CharField(default='BARRANQUILLA', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lote', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lote', to='bar.lotebar')),
                ('tanque', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tanque', to='bar.tanquebar')),
                ('uc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Usuario que Crea')),
            ],
            options={
                'ordering': ['-creado'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('um', models.IntegerField(blank=True, null=True, verbose_name='Usuario que modifica')),
                ('tanque', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bar.tanquebar')),
                ('uc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Usuario que Crea')),
            ],
        ),
    ]
