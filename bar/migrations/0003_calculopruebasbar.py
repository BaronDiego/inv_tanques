...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bar', '0002_tanquebar_bodega'),
    ]

    operations = [
        migrations.CreateModel(
            name='CalculoPruebasBar',
            fields=[
                ...
                ('lote', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bar.lotebar', verbose_name='Referencia/Lote')),
