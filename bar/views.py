...
from .models import AforoTanqueBar, CalculoBar, TanqueBar, LoteBar, CalculoPruebasBar
from .resources import AforoTanqueResourse
from .forms import CalculoForm, TanqueForm, LoteForm, CalculoForm2, CalculoFormPruebasBar
